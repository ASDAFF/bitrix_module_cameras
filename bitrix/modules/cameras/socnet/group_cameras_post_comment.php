...
$arComponentVariables = array('message_id','group_id','cameras_name');
...
if (!$dbElement || !($arElement = $dbElement->Fetch()) || !($arElement['IBLOCK_ID'] == COption::GetOptionString('cameras', 'socnet_iblock_id')))
	return;
...
$redirectPath = CComponentEngine::MakePathFromTemplate($arResult['PATH_TO_GROUP_CAMERAS_POST_CATEGORY'],
															array(
																"cameras_name" => rawurlencode($arElement['NAME']),
