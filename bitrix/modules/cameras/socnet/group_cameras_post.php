...
if (!empty($ID))
{
	$APPLICATION->IncludeComponent(
		...
		Array(
			...
			'ELEMENT_NAME' => isset($arResult['VARIABLES']['title']) ? $arResult['VARIABLES']['title'] : $arResult['VARIABLES']['cameras_name'],
			'SOCNET_GROUP_ID' => $arResult['VARIABLES']['group_id'],
			'MESSAGES_PER_PAGE' => COption::GetOptionString('cameras', 'socnet_message_per_page',20),
			'USE_CAPTCHA' => COption::GetOptionString('cameras', 'socnet_use_captcha','Y'),
			'FORUM_ID' => COption::GetOptionString('cameras', 'socnet_forum_id'),
