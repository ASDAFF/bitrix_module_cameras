...
class CCamerasSecurity
{
	...
	*/
	...
	{
		$str = preg_replace_callback("/\&\#(\d+)([^\d])/is", array("CCamerasSecurity", "_decode_cb"), $str);
		$str = preg_replace_callback("/\&\#x([\da-f]+)([^\da-f])/is", array("CCamerasSecurity", "_decode_cb_hex"), $str);
